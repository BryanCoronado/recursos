...
function ResourceCard({
  ...
  return (
    <Link
      href={href}
      className="mich-soft-card mich-hover-card group flex items-center gap-4 p-5 sm:p-6"
    >
      <span className="flex size-12 shrink-0 items-center justify-center rounded-xl border border-[var(--mich-border)] bg-[var(--mich-surface-muted)] p-2">
        <Image
          src={logoSrc}
          alt=""
          width={40}
      ...
      <ArrowUpRight className="size-5 shrink-0 text-[var(--mich-muted)] transition group-hover:text-[var(--mich-text)]" />
    </Link>
  )
}
...
function MetricCard({
  ...
  return (
    <div className="mich-soft-card px-4 py-4">
